...
describe("usePreviousAndNextPages", () => {
  it("calculates page before current one", function () {
  ...
  describe("when current page is the first page", () => {
    it("does not provide previous page", function () {
  ...
  it("calculates page after current one", function () {
    const currentPage = { value: 8 };
    const maxPage = { value: 10 };
  ...
  describe("when current page is the last page", () => {
    it("does not provide next page", function () {
      const currentPage = { value: 8 };
