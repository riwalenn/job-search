...
import { UNIQUE_DEGREES } from "@/store/constants";
...
describe("getters", () => {
  ...
  describe("UNIQUE_DEGREES", () => {
    it("extracts unique degree values", function () {
      const degrees = [
  ...
  describe("INCLUDE_JOB_BY_DEGREE", () => {
    ...
    it("identifies if job is associated with given degrees", function () {
      const state = createState({
  ...
  describe("INCLUDE_JOB_BY_SKILL", () => {
    it("identifies if job matcher user's skill", function () {
  ...
  describe("FILTERED_JOBS", () => {
    it("filters jobs by organization, job type, degree and skills", function () {
